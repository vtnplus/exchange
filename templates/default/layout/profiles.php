    ...
    <nav class="sidebar col-lg-2 col-sm-hidden">
      <form class="bd-search d-flex align-items-center">
          ...
          <div class="list-group">
            <a class="list-group-item" href="<?php echo router("profiles/infomation");?>">Info</a>
            <a class="list-group-item" href="<?php echo router("profiles/changepassword");?>">Change Password</a>
            <a class="list-group-item active" href="<?php echo router("profiles/security");?>">Security</a>
            <a class="list-group-item" href="<?php echo router("profiles/openapi");?>">API</a>
            <a class="list-group-item" href="<?php echo router("profiles/validate");?>">Validate</a>
            <a class="list-group-item" href="<?php echo router("profiles/bankaccount");?>">Bank Account</a>
          </div>
